...
static const PinMap PinMap_I2C_SDA[] = {
    {P0_0, I2C_1, 3}, {P0_10, I2C_2, 2}, {P0_19, I2C_1, 3}, {P0_27, I2C_0, 1}, {NC, NC, 0}};

static const PinMap PinMap_I2C_SCL[] = {
    {P0_1, I2C_1, 3}, {P0_11, I2C_2, 2}, {P0_20, I2C_1, 3}, {P0_28, I2C_0, 1}, {NC, NC, 0}};
...
static const PinMap PinMap_I2C_SDA[] = {{P0_5, I2C_0, 1}, {NC, NC, 0}};

static const PinMap PinMap_I2C_SCL[] = {{P0_4, I2C_0, 1}, {NC, NC, 0}};
...
static const uint32_t I2C_addr_offset[2][4] = {{0x0C, 0x20, 0x24, 0x28}, {0x30, 0x34, 0x38, 0x3C}};

static int i2c_timed_out = 0;

static void i2c_conclr(i2c_t* obj, int start, int stop, int interrupt, int acknowledge) {
  I2C_CONCLR(obj) = (start << 5) | (stop << 4) | (interrupt << 3) | (acknowledge << 2);
}

static void i2c_conset(i2c_t* obj, int start, int stop, int interrupt, int acknowledge) {
  I2C_CONSET(obj) = (start << 5) | (stop << 4) | (interrupt << 3) | (acknowledge << 2);
}

// Clear the Serial Interrupt (SI)
static void i2c_clear_SI(i2c_t* obj) { i2c_conclr(obj, 0, 0, 1, 0); }

static int i2c_status(i2c_t* obj) { return I2C_STAT(obj); }
...
static void i2c_interface_enable(i2c_t* obj) { I2C_CONSET(obj) = 0x40; }
...
int i2c_byte_read(i2c_t* obj, int last) { return (i2c_do_read(obj, last) & 0xFF); }
...
int i2c_slave_read(i2c_t* obj, char* data, int length) {
  ...
  do {
    ...
    count++;
  } while (((status == 0x80) || (status == 0x90) || (status == 0x060) || (status == 0x70)) && (count < length));
