...
uint32_t us_ticker_read() {
  if (!us_ticker_running) us_ticker_init();
...
static inline void us_ticker_disable_interrupt(void) { US_TICKER_TIMER->MCR &= ~1; }

static inline void us_ticker_clear_interrupt(void) { US_TICKER_TIMER->IR = 1; }
