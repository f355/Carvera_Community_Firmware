...
static const PinMap PinMap_ADC[] = {{P0_23, ADC0_0, 1}, {P0_24, ADC0_1, 1}, {P0_25, ADC0_2, 1},
                                    {P0_26, ADC0_3, 1}, {P1_30, ADC0_4, 3}, {P1_31, ADC0_5, 3},
#ifdef TARGET_LPC1768
                                    {P0_2, ADC0_7, 2},  {P0_3, ADC0_6, 2},
#endif
                                    {NC, NC, 0}};
...
static const PinMap PinMap_ADC[] = {{P0_11, ADC0_0, 0x02}, {P0_12, ADC0_1, 0x02}, {P0_13, ADC0_2, 0x02},
                                    {P0_14, ADC0_3, 0x02}, {P0_15, ADC0_4, 0x02}, {P0_16, ADC0_5, 0x01},
                                    {P0_22, ADC0_6, 0x01}, {P0_23, ADC0_7, 0x01}, {NC, NC, 0}};
...
void analogin_init(analogin_t* obj, PinName pin) {
  ...
  __IO uint32_t* reg = (pin_number < 32) ? (__IO uint32_t*)(LPC_IOCON0_BASE + 4 * pin_number)
