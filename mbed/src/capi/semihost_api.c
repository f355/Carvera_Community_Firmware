...
int semihost_close(FILEHANDLE fh) { return __semihost(SYS_CLOSE, &fh); }
...
int semihost_istty(FILEHANDLE fh) { return __semihost(SYS_ISTTY, &fh); }
...
int semihost_ensure(FILEHANDLE fh) { return __semihost(SYS_ENSURE, &fh); }

long semihost_flen(FILEHANDLE fh) { return __semihost(SYS_FLEN, &fh); }
...
int semihost_vbus(void) { return __semihost(USR_VBUS, NULL); }

int semihost_powerdown(void) { return __semihost(USR_POWERDOWN, NULL); }
...
int semihost_connected(void) { return is_debugger_attached; }
#endif
