...
// USB Stuff
// SDCard sd  __attribute__ ((section ("AHBSRAM"))) (P0_18, P0_17, P0_15, P0_16);      // this selects SPI1 as the
// sdcard as it is on Smoothieboard
...
GPIO leds[4] = {GPIO(P4_29), GPIO(P4_28), GPIO(P0_4), GPIO(P1_17)};
...
// these modules can be completely disabled in the Makefile by adding to EXCLUDE_MODULES
  ...
  // // NOTE this must be done first before Temperature control so ToolManager can handle Tn before temperaturecontrol
  // module does ExtruderMaker *em= new(AHB) ExtruderMaker(); em->load_tools(); delete em; #endif
