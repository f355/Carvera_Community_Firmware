...
void RotatableCartesianSolution::cartesian_to_actuator(const float cartesian_mm[],
                                                       ActuatorCoordinates& actuator_mm) const {
  rotate(cartesian_mm, &actuator_mm[0], sin_alpha, cos_alpha);
}

void RotatableCartesianSolution::actuator_to_cartesian(const ActuatorCoordinates& actuator_mm,
