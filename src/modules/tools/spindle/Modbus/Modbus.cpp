...
void Modbus::on_serial_char_received() { buffer.push_back(serial->getc()); }
...
void Modbus::read_write_multiple_holding_registers(int slave_addr, int read_addr, int n_read, int write_addr,
                                                   int data) {
  // TODO: implement this
}
