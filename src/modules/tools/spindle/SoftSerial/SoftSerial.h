...
class SoftSerial : public Stream {
 public:
   ...
   *  @param parity The parity used (SerialBase::None, SerialBase::Odd, SerialBase::Even, SerialBase::Forced1,
   ...
   */
  void attach(void (*fptr)(void), IrqType type = RxIrq) { fpointer[type].attach(fptr); }
