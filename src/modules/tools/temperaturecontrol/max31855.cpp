...
Max31855::Max31855() : spi(nullptr) { this->read_flag = true; }

Max31855::~Max31855() { delete spi; }

// Get configuration from the config file
void Max31855::UpdateConfig(uint16_t module_checksum, uint16_t name_checksum) {
  // Chip select
  this->spi_cs_pin.from_string(
      THEKERNEL->config->value(module_checksum, name_checksum, chip_select_checksum)->as_string("0.16"));
