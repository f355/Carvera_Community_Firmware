...
// NOTE the order of these tables must NOT be changed as the index can be used in M305 to set the prefined thermistor to
// use
...
static const thermistor_beta_table_t predefined_thermistors_beta[]{
    ...
    {"RRRF100K", 0, 4700, 3960.0F, 100000.0F, 25.0F},      {"RRRF10K", 680, 1600, 3964.0F, 10000.0F, 25.0F},
