...
private:
    ...
    bool await_sdo(uint8_t node, uint16_t index, uint8_t subindex,
                   bool upload, uint32_t timeout_us, uint32_t& value, uint8_t& size);
    bool sdo_read(uint8_t node, uint16_t index, uint8_t subindex,
                  uint32_t& value, uint8_t& size);
    bool sdo_write(uint8_t node, uint16_t index, uint8_t subindex,
                   uint32_t value, uint8_t size);
