...
// #define  M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN				  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD,
// ENABLE) #define  M8266WIFI_nRESET_GPIO
// GPIOD #define  M8266WIFI_nRESET_PIN
// GPIO_Pin_13 using *GPIOB9* as nRESET
#define M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE)
#define M8266WIFI_nRESET_GPIO GPIOB
#define M8266WIFI_nRESET_PIN GPIO_Pin_9
// using *GPIOA0* as nRESET
// #define  M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN				  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA,
// ENABLE) #define  M8266WIFI_nRESET_GPIO
// GPIOA #define  M8266WIFI_nRESET_PIN
// GPIO_Pin_0 using *GPIOE4* as nRESET #define  M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN
// RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOE, ENABLE) #define  M8266WIFI_nRESET_GPIO
// GPIOE #define  M8266WIFI_nRESET_PIN
// GPIO_Pin_4
#elif defined(MCU_IS_STM32F7XX)  // STM's STM32F7XX, using *GPIOB2* as nRESET  // avoid to use PE3, boards like Aplolo
                                 // have problems in output high simutenous to nearby PIO e.g. PE3&PE4
...
// #define  M8266WIFI_nRESET_GPIO GPIOB #define  M8266WIFI_nRESET_PIN
// GPIO_PIN_2
...
#elif defined(MCU_IS_STM32F4XX)  // STM's STM32F4XX
// using *GPIOA8* as nCS
// #define  M8266WIFI_SPI_nCS_GPIO_RCC_CLOCK_EN				RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA,
// ENABLE) #define  M8266WIFI_SPI_nCS_GPIO
// GPIOA #define  M8266WIFI_SPI_nCS_PIN GPIO_Pin_8 using *GPIOD3* as nCS
...
// #define  M8266WIFI_SPI_nCS_GPIO_RCC_CLOCK_EN		  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA, ENABLE)
// #define  M8266WIFI_SPI_nCS_GPIO										GPIOA
// #define  M8266WIFI_SPI_nCS_PIN GPIO_Pin_4 using *GPIOE6* as nCS #define  M8266WIFI_SPI_nCS_GPIO_RCC_CLOCK_EN
// RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOE, ENABLE) #define  M8266WIFI_SPI_nCS_GPIO
// GPIOE #define  M8266WIFI_SPI_nCS_PIN GPIO_Pin_6
...
#define M8266WIFI_SPI_INTERFACE_NO \
  1  // STM32: 1~. for STM32F4xx, try to use SPI1 other than SPI2 and SPI3, since according to datasheet, SPI1 has a
     // better performance than SPI2 and SPI3 NXP:   0~
...
//////////////////////////////////////////////////////////////////////////////////
    ...
    defined(MCU_IS_STM32F4XX) || defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L4XX)
#define MCU_IS_STM32
#endif
...
#define GPIO_OUTPUT_LOW(gpio, pin) (gpio)->BSRRH = pin
    ...
    defined(MCU_IS_STM32L4XX)                                  // STM's STM32F3XX, STM32F7XX, STM32L4XX
...
#define GPIO_InitStructure_AS_AF(gpio, pins)        \
  ...
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; \
  GPIO_Init(gpio, &GPIO_InitStructure)
#elif defined(MCU_IS_STM32F2XX) || defined(MCU_IS_STM32F3XX) || \
    defined(MCU_IS_STM32F4XX)  // STM's STM32F2XX, STM32F3XX, STM's STM32F4XX
#define GPIO_InitStructure_AS_AF(gpio, pins)         \
  GPIO_InitStructure.GPIO_Pin = pins;                \
...
#define GPIO_PinRemapSPI0                 \
  ...
  LPC_PINCON->PINSEL0 |= (0x02UL << 30);  \
  LPC_PINCON->PINSEL1 &= ~(0x03UL << 2);  \
  LPC_PINCON->PINSEL1 |= (0x02UL << 2);   \
  LPC_PINCON->PINSEL1 &= ~(0x03UL << 4);  \
  LPC_PINCON->PINSEL1 |= (0x02UL << 4);   \
...
#if defined(MCU_IS_STM32F1XX)
#define GPIO_PinRemapSPI1 GPIO_PinRemapConfig(GPIO_Remap_SPI1, ENABLE);
#elif defined(MCU_IS_STM32F2XX) || defined(MCU_IS_STM32F3XX) || defined(MCU_IS_STM32F4XX) || \
    defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L4XX)
...
#define GPIO_PinRemapSPI1                 \
  LPC_PINCON->PINSEL0 &= ~(0x03UL << 14); \
  LPC_PINCON->PINSEL0 |= (0x02UL << 14);  \
  LPC_PINCON->PINSEL0 &= ~(0x03UL << 16); \
  LPC_PINCON->PINSEL0 |= (0x02UL << 16);  \
  LPC_PINCON->PINSEL0 &= ~(0x03UL << 18); \
  LPC_PINCON->PINSEL0 |= (0x02UL << 18);  \
...
#if defined(MCU_IS_STM32F1XX)
#define GPIO_PinRemapSPI3 GPIO_PinRemapConfig(GPIO_Remap_SPI3, ENABLE);
#elif defined(MCU_IS_STM32F2XX) || defined(MCU_IS_STM32F3XX) || defined(MCU_IS_STM32F4XX) || \
    defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L4XX)
...
#if defined(MCU_IS_STM32F1XX)
#define GPIO_PinRemapUSART1 GPIO_PinRemapConfig(GPIO_Remap_USART1, ENABLE);
#elif defined(MCU_IS_STM32F2XX) || defined(MCU_IS_STM32F3XX) || defined(MCU_IS_STM32F4XX) || \
    defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L4XX)
...
#if defined(MCU_IS_STM32F1XX)
#define GPIO_PinRemapUSART2 GPIO_PinRemapConfig(GPIO_Remap_USART2, ENABLE);
#elif defined(MCU_IS_STM32F2XX) || defined(MCU_IS_STM32F3XX) || defined(MCU_IS_STM32F4XX) || \
    defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L4XX)
...
#if 1  // for a customer2's Board  ( LED[1-4] - R[49-52] - VCC )  || PF6-LED1-R49-VCC, PB12-LED2-R50-VCC,
       // PE0-LED3-R51-VCC, PB8-LED4-R52-VCC,
...
// GPIO_Pin_2 #define LED3_GPIO_PIN
// GPIO_Pin_3
#endif
...
// GPIO_Pin_2 #define LED3_GPIO_PIN
// GPIO_Pin_3
#elif 0  // for a customer2's Board  ( LED[1-4] - R[49-52] - VCC )  || PF6-LED1-R49-VCC, PB12-LED2-R50-VCC,
         // PE0-LED3-R51-VCC, PB8-LED4-R52-VCC,
#define RCC_AHB1Periph_GPIO_LEDS RCC_AHB1Periph_GPIOB
#define LED_GPIOS GPIOB
#define LED0_GPIO_PIN GPIO_Pin_8
