...
void MainButton::on_module_loaded() {
  ...
  this->main_button_LED_R.from_string(THEKERNEL->config->value(main_button_LED_R_pin_checksum)->as_string("1.10"))
      ->as_output();
  this->main_button_LED_G.from_string(THEKERNEL->config->value(main_button_LED_G_pin_checksum)->as_string("1.15"))
      ->as_output();
  this->main_button_LED_B.from_string(THEKERNEL->config->value(main_button_LED_B_pin_checksum)->as_string("1.14"))
      ->as_output();
  ...
  this->enable_light =
      THEKERNEL->config->value(get_checksum("switch"), get_checksum("light"), get_checksum("startup_state"))
          ->as_bool(false);
...
void MainButton::switch_power_12(int state) { this->PS12.set(state); }

void MainButton::switch_power_24(int state) { this->PS24.set(state); }
...
void MainButton::on_idle(void* argument) {
  ...
  if (e_stop_pressed || button_state == BUTTON_LED_UPDATE || button_state == BUTTON_SHORT_PRESSED ||
  ...
  if (this->main_button.get()) {
    ...
    if (us_ticker_read() - this->button_press_time > this->long_press_time_ms * 1000) {
      ...
      if (CARVERA_AIR == THEKERNEL->factory_set->MachineModel) {
        ...
        float progress =
            (float)(us_ticker_read() - this->button_press_time) / ((float)this->long_press_time_ms * 1000.0f);
      ...
      switch (THEKERNEL->get_state()) {
        case IDLE:
          if (this->long_press_enable == "ToolChange") {
            ...
            this->set_led_colors(this->hold_toggle % 4 < 2 ? 0 : 104, this->hold_toggle % 4 < 2 ? 0 : 104,
                                 this->hold_toggle % 4 < 2 ? 0 : 104);
          } else if (this->long_press_enable == "Repeat") {
    ...
    switch (state) {
      ...
      case TOOL:
        ...
        switch (tool.target_tool) {
          case 1:
            if (this->hold_toggle % 5 == 0) this->set_led_num(r, g, b, 0, 0, 0, 1);
            if (this->hold_toggle % 5 == 1) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 2) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 3) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 4) this->set_led_colors(0, 0, 0);
            break;
          case 2:
            if (this->hold_toggle % 5 == 0) this->set_led_num(r, g, b, 0, 0, 0, 2);
            if (this->hold_toggle % 5 == 1) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 2) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 3) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 4) this->set_led_colors(0, 0, 0);
            break;
          case 3:
            if (this->hold_toggle % 5 == 0) this->set_led_num(r, g, b, 0, 0, 0, 3);
            if (this->hold_toggle % 5 == 1) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 2) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 3) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 4) this->set_led_colors(0, 0, 0);
          ...
          case 4:
            if (this->hold_toggle % 5 == 0) this->set_led_num(r, g, b, 0, 0, 0, 3);
            if (this->hold_toggle % 5 == 1) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 2) this->set_led_num(r, g, b, 0, 0, 0, 1);
            if (this->hold_toggle % 5 == 3) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 4) this->set_led_colors(0, 0, 0);
            break;
          case 5:
            if (this->hold_toggle % 5 == 0) this->set_led_num(r, g, b, 0, 0, 0, 3);
            if (this->hold_toggle % 5 == 1) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 2) this->set_led_num(r, g, b, 0, 0, 0, 2);
            if (this->hold_toggle % 5 == 3) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 4) this->set_led_colors(0, 0, 0);
            break;
          case 6:
            if (this->hold_toggle % 5 == 0) this->set_led_num(r, g, b, 0, 0, 0, 3);
            if (this->hold_toggle % 5 == 1) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 2) this->set_led_num(r, g, b, 0, 0, 0, 3);
            if (this->hold_toggle % 5 == 3) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 4) this->set_led_colors(0, 0, 0);
            break;
          default:
            if (this->hold_toggle % 5 == 0) this->set_led_colors(r, g, b);
            if (this->hold_toggle % 5 == 1) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 2) this->set_led_colors(r, g, b);
            if (this->hold_toggle % 5 == 3) this->set_led_colors(0, 0, 0);
            if (this->hold_toggle % 5 == 4) this->set_led_colors(0, 0, 0);
            break;
        }
...
void MainButton::set_led_color(unsigned char R1, unsigned char G1, unsigned char B1, unsigned char R2, unsigned char G2,
                               unsigned char B2, unsigned char R3, unsigned char G3, unsigned char B3, unsigned char R4,
                               unsigned char G4, unsigned char B4, unsigned char R5, unsigned char G5,
                               unsigned char B5) {
...
void MainButton::set_led_num(unsigned char ColorFR, unsigned char ColorFG, unsigned char ColorFB, unsigned char ColorBR,
                             unsigned char ColorBG, unsigned char ColorBB, unsigned char num, bool row) {
  __disable_irq();
  if (!row) {
    switch (num) {
      case 1:
        set_led_color(ColorFR, ColorFG, ColorFB, ColorBR, ColorBG, ColorBB, ColorBR, ColorBG, ColorBB, ColorBR, ColorBG,
                      ColorBB, ColorBR, ColorBG, ColorBB);
        ...
        break;
      case 2:
        set_led_color(ColorFR, ColorFG, ColorFB, ColorBR, ColorBG, ColorBB, ColorFR, ColorFG, ColorFB, ColorBR, ColorBG,
                      ColorBB, ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
      ...
      case 3:
        set_led_color(ColorFR, ColorFG, ColorFB, ColorBR, ColorBG, ColorBB, ColorFR, ColorFG, ColorFB, ColorBR, ColorBG,
                      ColorBB, ColorFR, ColorFG, ColorFB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorFR, ColorFG, ColorFB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorFR, ColorFG, ColorFB);
    ...
    switch (num) {
      case 1:
        ...
        break;
      case 2:
        set_led_color(ColorFR, ColorFG, ColorFB, ColorFR, ColorFG, ColorFB, ColorBR, ColorBG, ColorBB, ColorBR, ColorBG,
                      ColorBB, ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorFR, ColorFG, ColorFB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        ...
        break;
      case 3:
        set_led_color(ColorFR, ColorFG, ColorFB, ColorFR, ColorFG, ColorFB, ColorFR, ColorFG, ColorFB, ColorBR, ColorBG,
                      ColorBB, ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorFR, ColorFG, ColorFB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        ...
        break;
      case 4:
        set_led_color(ColorFR, ColorFG, ColorFB, ColorFR, ColorFG, ColorFB, ColorFR, ColorFG, ColorFB, ColorFR, ColorFG,
                      ColorFB, ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorFR, ColorFG, ColorFB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorFR, ColorFG, ColorFB);
      ...
      case 5:
        set_led_color(ColorFR, ColorFG, ColorFB, ColorFR, ColorFG, ColorFB, ColorFR, ColorFG, ColorFB, ColorFR, ColorFG,
                      ColorFB, ColorFR, ColorFG, ColorFB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorFR, ColorFG, ColorFB);
        // set_led_color(ColorBR, ColorBG, ColorBB);
        // set_led_color(ColorFR, ColorFG, ColorFB);
