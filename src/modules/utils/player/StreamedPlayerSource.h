...
public:
    ...
    void begin(uint16_t file_id, unsigned long file_size, uint32_t first_line = 0,
               unsigned long byte_position = 0);
    AcceptResult accept(uint16_t file_id, uint32_t first_line,
