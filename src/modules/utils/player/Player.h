...
class Player : public Module {
 ...
 private:
  ...
  // 2024
  // bool check_cluster(const char *gcode_str, float *x_value, float *y_value, float *distance, float *slope, float
  // *s_value);
  ...
  using macro_file_queue_item =
      std::tuple<std::string, unsigned long>;  // allows running macros. This forms a stact filepath, line number, to
                                               // return to when the internal file is complete
