...
class OCodeHandler {
 ...
 private:
  ...
  bool skip_to(FILE* fh, const std::string& open_kw, const std::string& close_kw, std::string& matched, int& lines_read,
               int target_num = -1, std::string* matched_rest = NULL) const;
