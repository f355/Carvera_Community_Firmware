...
void test_kernel_trap_event(_EVENT_ENUM id_event, std::function<void(void*)> fnc) { event_callbacks[id_event] = fnc; }

void test_kernel_untrap_event(_EVENT_ENUM id_event) { event_callbacks.erase(id_event); }
