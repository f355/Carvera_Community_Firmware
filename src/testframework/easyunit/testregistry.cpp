...
TestRegistry::TestRegistry()
    : currentTC_(0), defaultPrinter_(new DefaultTestPrinter()), testCaseCount_(0), defaultRunner_(new TestRunner()) {}
...
const TestResult* TestRegistry::run() { return instance().runTests(instance().defaultRunner_); }

const TestResult* TestRegistry::run(TestRunner* runner) { return instance().runTests(runner); }
