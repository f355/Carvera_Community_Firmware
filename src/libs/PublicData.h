...
#define PTYPE_CONFIG_FINISH    0xD4
#define PTYPE_CONFIG_CANCEL    0xD5

#define PTYPE_FACTORY_START    0xE1
#define PTYPE_FACTORY_VIEW    0xE2
#define PTYPE_FACTORY_DATA    0xE3
#define PTYPE_FACTORY_FINISH    0xE4
#define PTYPE_FACTORY_CANCEL    0xE5

#define PTYPE_PLAY_START    0xF1
#define PTYPE_PLAY_VIEW        0xF2
#define PTYPE_PLAY_DATA        0xF3
#define PTYPE_PLAY_ERROR    0xF4
#define PTYPE_PLAY_CANCEL    0xF5
#define PTYPE_PLAY_GOTO        0xF6
#define PTYPE_PLAY_GOTO_DATA    0xF7

#define PTYPE_VERSION_RES    0x71
