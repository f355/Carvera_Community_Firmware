...
FATDirHandle::FATDirHandle(const DIR_t& the_dir) { dir = the_dir; }
...
void FATDirHandle::rewinddir() { dir.index = 0; }

off_t FATDirHandle::telldir() { return dir.index; }

void FATDirHandle::seekdir(off_t location) { dir.index = location; }
