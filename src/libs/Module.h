...
// When adding a new event the virtual method needs to be defined in class Module and the method pointer need to be
// defined in Module.cpp:16 in the same order
enum _EVENT_ENUM {
  ON_MAIN_LOOP,
