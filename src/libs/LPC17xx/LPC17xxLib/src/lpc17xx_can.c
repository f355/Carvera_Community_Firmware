...
/********************************************************************/ /**
                                                                        ...
                                                                        * peripheral with given baudrate
...
/********************************************************************/ /**
                                                                        ...
                                                                        * @return 		CAN Error	could
                                                                        * be:
                                                                        * 				-
                                                                        * CAN_OBJECTS_FULL_ERROR: No more rx or tx
                                                                        * objects available
                                                                        * 				-
                                                                        * CAN_AF_ENTRY_ERROR: table error-violation of
                                                                        * ascending numerical order
                                                                        * 				- CAN_OK: ID is
                                                                        * added into table successfully
                                                                        *********************************************************************/
...
/********************************************************************/ /**
                                                                        * @brief		Add Explicit ID into AF
                                                                        * Look-Up Table dynamically.
                                                                        * @param[in]	CANx pointer to LPC_CAN_TypeDef,
                                                                        * should be:
                                                                        * 				- LPC_CAN1: CAN1
                                                                        * peripheral
...
/********************************************************************/ /**
                                                                        ...
                                                                        * 				-
                                                                        * CAN_ID_EXIT_ERROR: ID exited in FullCAN
                                                                        * Section
                                                                        * 				-
                                                                        * CAN_OBJECTS_FULL_ERROR: no more space
                                                                        * available
                                                                        *********************************************************************/
...
/********************************************************************/ /**
                                                                        ...
                                                                        * should be:
                                                                        * 				- STD_ID_FORMAT:
                                                                        * Standard ID format (11-bit value)
                                                                        * 				- EXT_ID_FORMAT:
                                                                        * Extended ID format (29-bit value)
                                                                        * @return 		CAN_ERROR, could be:
                                                                        * 				- CAN_OK:
                                                                        * loading is successful
                                                                        * 				-
...
/********************************************************************/ /**
                                                                        * @brief		Remove AFLUT entry
                                                                        * (FullCAN entry and Explicit Standard entry)
                                                                        ...
                                                                        * 				-
                                                                        * CAN_ENTRY_NOT_EXIT_ERROR: entry want to remove
                                                                        * is not exit
                                                                        *********************************************************************/
...
/********************************************************************/ /**
                                                                        ...
                                                                        * @return 		CAN_ERROR, could be:
                                                                        * 				-
                                                                        * CAN_FULL_OBJ_NOT_RCV: FullCAN Object is not be
                                                                        * received
                                                                        * 				- CAN_OK:
                                                                        * Received FullCAN Object successful
                                                                        *
                                                                        *********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * 				- CAN_CMR_RRB:
                                                                         * Release Receive Buffer request
                                                                         * 				- CAN_CMR_CDO:
                                                                         * Clear Data Overrun request
                                                                         * 				- CAN_CMR_SRR:
                                                                         * Self Reception request
                                                                         * 				- CAN_CMR_STB1:
                                                                         * Select Tx Buffer 1 request
                                                                         * 				- CAN_CMR_STB2:
                                                                         * Select Tx Buffer 2 request
                                                                         * 				- CAN_CMR_STB3:
                                                                         * Select Tx Buffer 3 request
                                                                         * @return		CANICR (CAN interrupt
                                                                         * and Capture register) value
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Check if FullCAN
                                                                         * interrupt enable or not
                                                                         * @param[in]	CANAFx point to
                                                                         * LPC_CANAF_TypeDef object, should be:
                                                                         * LPC_CANAF
                                                                         * @return		IntStatus, could be:
                                                                         * 				- SET: if
                                                                         * FullCAN interrupt is enable
                                                                         * 				- RESET: if
                                                                         * FullCAN interrupt is disable
                                                                         **********************************************************************/
IntStatus CAN_FullCANIntGetStatus(LPC_CANAF_TypeDef* CANAFx) {
  CHECK_PARAM(PARAM_CANAFx(CANAFx));
  if (CANAFx->FCANIE) return SET;
  return RESET;
}

/*********************************************************************/ /**
                                                                         * @brief		Get value of FullCAN
                                                                         ...
                                                                         * be:
                                                                         * 				- FULLCAN_IC0:
                                                                         * FullCAN Interrupt Capture 0
                                                                         * 				- FULLCAN_IC1:
                                                                         * FullCAN Interrupt Capture 1
                                                                         * @return		FCANIC0 or FCANIC1
...
uint32_t CAN_FullCANPendGetStatus(LPC_CANAF_TypeDef* CANAFx, FullCAN_IC_Type type) {
  ...
  if (type == FULLCAN_IC0) return CANAFx->FCANIC0;
