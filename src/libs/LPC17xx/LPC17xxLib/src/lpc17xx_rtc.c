...
/*********************************************************************/ /**
                                                                         * @brief 		Reset clock tick counter
                                                                         * in RTC peripheral
                                                                         * @param[in]	RTCx	RTC peripheral selected,
                                                                         * should be LPC_RTC
                                                                         * @return 		None
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * function, should be:
                                                                         * 				- ENABLE: The
                                                                         * time counters are enabled
                                                                         * 				- DISABLE: The
                                                                         * time counters are disabled
                                                                         * @return 		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * increment interrupt for each time type in RTC
                                                                         * peripheral
                                                                         * @param[in]	RTCx	RTC peripheral selected,
                                                                         * should be LPC_RTC
                                                                         * @param[in]	CntIncrIntType: Counter
                                                                         * Increment Interrupt type, an increment of
                                                                         * this type value below will generates an
                                                                         * interrupt, should be:
                                                                         * 				-
                                                                         * RTC_TIMETYPE_SECOND
                                                                         * 				-
                                                                         ...
                                                                         * function, should be:
                                                                         * 				- ENABLE:
                                                                         * Counter Increment interrupt for this time
                                                                         * type are enabled
                                                                         * 				- DISABLE:
                                                                         * Counter Increment interrupt for this time
                                                                         * type are disabled
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * interrupt for each time type in RTC
                                                                         * peripheral
                                                                         * @param[in]	RTCx	RTC peripheral selected,
                                                                         * should be LPC_RTC
                                                                         * @param[in]	AlarmTimeType: Alarm Time
                                                                         * Interrupt type, an matching of this type
                                                                         * value below with current time in RTC will
                                                                         * generates an interrupt, should be:
                                                                         * 				-
                                                                         * RTC_TIMETYPE_SECOND
                                                                         * 				-
                                                                         * RTC_TIMETYPE_MINUTE
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * 				-
                                                                         * RTC_TIMETYPE_YEAR
                                                                         * @return 		Value of time according
                                                                         * to specified time type
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief 		Set alarm time value for
                                                                         * each time type
                                                                         * @param[in]	RTCx	RTC peripheral selected,
                                                                         * should be LPC_RTC
                                                                         * @param[in]	Timetype: Time Type, should be:
...
/*********************************************************************/ /**
                                                                         * @brief 		Get alarm time value for
                                                                         * each time type
                                                                         * @param[in]	RTCx	RTC peripheral selected,
                                                                         * should be LPC_RTC
                                                                         * @param[in]	Timetype: Time Type, should be:
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * specified Location interrupt in RTC
                                                                         ...
                                                                         * Location interrupt in RTC peripheral (SET or
                                                                         * RESET)
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * calibration counter in RTC peripheral
                                                                         * @param[in]	RTCx	RTC peripheral selected,
                                                                         * should be LPC_RTC
                                                                         * @param[in]	NewState New State of this
                                                                         * function, should be:
                                                                         * 				- ENABLE: The
                                                                         * calibration counter is enabled and counting
                                                                         * 				- DISABLE: The
                                                                         * calibration counter is disabled and reset to
                                                                         * zero
                                                                         * @return 		None
                                                                         **********************************************************************/
