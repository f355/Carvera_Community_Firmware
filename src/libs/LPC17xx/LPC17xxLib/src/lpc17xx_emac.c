...
/*********************************************************************/ /**
                                                                         * @brief		Check specified PHY
                                                                         * status in EMAC peripheral
                                                                         * @param[in]	ulPHYState	Specified PHY
                                                                         ...
                                                                         * @return		Status of specified PHY
                                                                         * status (0 or 1).
                                                                         * 				(-1) if error.
                                                                         *
                                                                         * Note:
...
/*********************************************************************/ /**
                                                                         * @brief		Set specified PHY mode
                                                                         * in EMAC peripheral
                                                                         * @param[in]	ulPHYMode	Specified PHY
                                                                         * mode, should be:
                                                                         * 							-
                                                                         * EMAC_MODE_AUTO
                                                                         * 							-
...
/*********************************************************************/ /**
                                                                         * @brief		Auto-Configures value
                                                                         * for the EMAC configuration register to match
                                                                         * with current PHY mode
                                                                         * @param[in]	None
                                                                         * @return		Return (0) if no error,
                                                                         * otherwise return (-1)
                                                                         *
...
/*********************************************************************/ /**
                                                                         * @brief		Enable/Disable hash
                                                                         * filter functionality for specified
                                                                         * destination MAC address in EMAC module
                                                                         * @param[in]	dstMAC_addr		Pointer
                                                                         * to the first MAC destination address, should
                                                                         * 								be
                                                                         * 6-bytes length, in order LSB to the MSB
                                                                         * @param[in]	NewState		New
                                                                         * State of this command, should be:
                                                                         *									-
                                                                         * ENABLE.
                                                                         *									-
                                                                         * DISABLE.
                                                                         ...
                                                                         * bits [28:23] out of the 32 bits CRC result
                                                                         * are taken to form the hash. The 6 bit hash is
                                                                         * used to access the hash table: it is used as
                                                                         * an index in the 64 bit HashFilter register
                                                                         * that has been programmed with accept values.
                                                                         * If the selected accept value is 1, the frame
                                                                         * is accepted.
                                                                         **********************************************************************/
void EMAC_SetHashFilter(uint8_t dstMAC_addr[], FunctionalState NewState) {
  ...
  pReg = (crc > 31) ? ((volatile uint32_t*)&LPC_EMAC->HashFilterH) : ((volatile uint32_t*)&LPC_EMAC->HashFilterL);
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * mode for each specified type EMAC peripheral
                                                                         * @param[in]	ulFilterMode	Filter mode,
                                                                         * should be:
                                                                         * 								-
                                                                         * EMAC_RFC_UCAST_EN: all frames of unicast
...
/*********************************************************************/ /**
                                                                         * @brief		Get status of Wake On
                                                                         * LAN Filter for each specified type in EMAC
                                                                         ...
                                                                         * 								-
                                                                         * EMAC_WOL_UCAST_HASH: unicast frame that
...
/*********************************************************************/ /**
                                                                         * @brief		Write data to Tx packet
                                                                         * data buffer at current index due to
                                                                         * 				TxProduceIndex
                                                                         * @param[in]	pDataStruct		Pointer
                                                                         * to a EMAC_PACKETBUF_Type structure data that
...
/*********************************************************************/ /**
                                                                         * @brief		Read data from Rx packet
                                                                         * data buffer at current index due to
                                                                         * RxConsumeIndex
                                                                         * @param[in]	pDataStruct		Pointer
                                                                         * to a EMAC_PACKETBUF_Type structure data that
...
/*********************************************************************/ /**
                                                                         * @brief 		Check whether if
                                                                         * specified interrupt flag is set or not for
                                                                         * each interrupt type in EMAC and clear
                                                                         * interrupt pending if it is set.
                                                                         * @param[in]	ulIntType	Interrupt Type,
                                                                         * should be:
                                                                         * 							-
                                                                         * EMAC_INT_RX_OVERRUN: Receive Overrun
                                                                         ...
                                                                         * 							-
                                                                         * EMAC_INT_WAKEUP: Wakeup interrupt
                                                                         * @return		New state of specified
                                                                         * interrupt (SET or RESET)
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Check whether if the
                                                                         * current RxConsumeIndex is not equal to the
                                                                         * 				current
                                                                         * RxProduceIndex.
                                                                         * @param[in]	None
                                                                         * @return		TRUE if they're not
...
/*********************************************************************/ /**
                                                                         * @brief		Check whether if the
                                                                         * current TxProduceIndex is not equal to the
                                                                         * 				current
                                                                         * RxProduceIndex - 1.
                                                                         * @param[in]	None
                                                                         * @return		TRUE if they're not
                                                                         ...
                                                                         * buffer is available and data can be written
                                                                         * to transmit buffer to be sent.
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Get current status value
                                                                         * of receive data (due to RxConsumeIndex)
                                                                         ...
                                                                         * 							-
                                                                         * EMAC_RINFO_RANGE_ERR: Range error(exceeded
                                                                         * max size)
                                                                         * 							-
                                                                         ...
                                                                         * 							-
                                                                         * EMAC_RINFO_ERR: Error Occurred (OR of all
                                                                         * error)
                                                                         * @return		Current value of receive
...
/*********************************************************************/ /**
                                                                         * @brief		Get size of current
                                                                         * Received data in received buffer (due to
                                                                         * 				RxConsumeIndex)
                                                                         * @param[in]	None
...
/*********************************************************************/ /**
                                                                         * @brief		Increase the
                                                                         * RxConsumeIndex (after reading the Receive
                                                                         * buffer to release the Receive buffer) and
                                                                         * wrap-around the index if it reaches the
...
/*********************************************************************/ /**
                                                                         * @brief		Increase the
                                                                         * TxProduceIndex (after writting to the
                                                                         * Transmit buffer to enable the Transmit
                                                                         * buffer) and wrap-around the index if it
