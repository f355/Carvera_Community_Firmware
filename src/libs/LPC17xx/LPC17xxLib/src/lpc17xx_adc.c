...
/*********************************************************************/ /**
                                                                         * @brief 		Get Result conversion
                                                                         * from A/D data register
...
/*********************************************************************/ /**
                                                                         * @brief 		Set AD conversion in
                                                                         * power mode
                                                                         * @param[in]	ADCx pointer to LPC_ADC_TypeDef,
                                                                         * should be: LPC_ADC
                                                                         * @param[in]	NewState
                                                                         * 				-	1: AD
                                                                         * converter is optional -	0: AD Converter
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * Interrupt channel 7
                                                                         * 				- ADC_ADGINTEN:
                                                                         * Individual channel/global flag done generate
                                                                         * an interrupt
                                                                         * @param[in]	NewState:
                                                                         * 					- SET :
