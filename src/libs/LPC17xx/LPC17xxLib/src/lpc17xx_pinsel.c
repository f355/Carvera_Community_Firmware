...
/*********************************************************************/ /**
                                                                         ...
                                                                         * the following:
                                                                         * 				-
                                                                         * PINSEL_I2C_Normal_Mode : The standard drive
                                                                         * mode
                                                                         * 				-
                                                                         * PINSEL_I2C_Fast_Mode : Fast Mode Plus drive
                                                                         * mode
                                                                         *
                                                                         * @param[in]	filterSlewRateEnable  should be:
                                                                         * 				- ENABLE: Enable
                                                                         * filter and slew rate.
                                                                         * 				- DISABLE:
                                                                         * Disable filter and slew rate.
                                                                         *
                                                                         * @return 		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief 		Configure Pin
                                                                         * corresponding to specified parameters passed
                                                                         * 				in the PinCfg
