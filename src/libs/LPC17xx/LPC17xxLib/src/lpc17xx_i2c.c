...
/*--------------------------------------------------------------------------------*/
/********************************************************************/ /**
                                                                        * @brief		Convert from I2C
                                                                        * peripheral to number
                                                                        * @param[in]	I2Cx: I2C peripheral selected,
                                                                        * should be:
                                                                        * 				- LPC_I2C0
                                                                        * 				- LPC_I2C1
                                                                        * 				- LPC_I2C2
                                                                        * @return 		I2C number, could be:
                                                                        * 0..2
                                                                        *********************************************************************/
static int32_t I2C_getNum(LPC_I2C_TypeDef* I2Cx) {
  if (I2Cx == LPC_I2C0) {
...
/********************************************************************/ /**
                                                                        * @brief		Generate a start
                                                                        * condition on I2C bus (in master mode only)
                                                                        * @param[in]	I2Cx: I2C peripheral selected,
                                                                        * should be:
                                                                        * 				- LPC_I2C0
                                                                        * 				- LPC_I2C1
                                                                        * 				- LPC_I2C2
                                                                        * @return 		value of I2C status
                                                                        * register after generate a start condition
                                                                        *********************************************************************/
static uint32_t I2C_Start(LPC_I2C_TypeDef* I2Cx) {
...
/********************************************************************/ /**
                                                                        ...
                                                                        * @param[in]	ack		assert
                                                                        * acknowledge or not, should be: TRUE/FALSE
                                                                        * @return 		value of I2C status
                                                                        * register after sending
                                                                        *********************************************************************/
static uint32_t I2C_GetByte(LPC_I2C_TypeDef* I2Cx, uint8_t* retdat, Bool ack) {
...
/********************************************************************/ /**
                                                                        * @brief		Initializes the I2Cx
                                                                        * peripheral with specified parameter.
                                                                        * @param[in]	I2Cx	I2C peripheral selected,
                                                                        * should be
                                                                        * 				- LPC_I2C0
                                                                        * 				- LPC_I2C1
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * 				- ENABLE: enable
                                                                         * interrupt for this I2C peripheral
                                                                         * 				- DISABLE:
                                                                         * disable interrupt for this I2C peripheral
                                                                         * @return 		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief 		General Master Interrupt
                                                                         * handler for I2C peripheral
                                                                         * @param[in]	I2Cx	I2C peripheral selected,
                                                                         * should be:
                                                                         * 				- LPC_I2C
                                                                         * 				- LPC_I2C1
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * data in master mode
                                                                         * @param[in]	I2Cx			I2C
                                                                         * peripheral selected, should be:
                                                                         *  			- LPC_I2C0
                                                                         * 				- LPC_I2C1
                                                                         * 				- LPC_I2C2
                                                                         * @param[in]	TransferCfg		Pointer
                                                                         * to a I2C_M_SETUP_Type structure that contains
                                                                         * specified information about the configuration
                                                                         * for master transfer.
                                                                         * @param[in]	Opt
                                                                         *	a I2C_TRANSFER_OPT_Type type that
                                                                         * selected for interrupt or polling mode.
                                                                         ...
                                                                         * either receive length set to 0 or receive
                                                                         * data pointer set to NULL.
...
Status I2C_MasterTransferData(LPC_I2C_TypeDef* I2Cx, I2C_M_SETUP_Type* TransferCfg, I2C_TRANSFER_OPT_Type Opt) {
  ...
  retry:
    ...
    if ((TransferCfg->tx_length != 0) && (TransferCfg->tx_data != NULL) && (TransferCfg->rx_length != 0) &&
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * 				- LPC_I2C2
                                                                         * @param[in]	TransferCfg		Pointer
                                                                         * to a I2C_S_SETUP_Type structure that contains
                                                                         * specified information about the configuration
                                                                         * for master transfer.
                                                                         * @param[in]	Opt
                                                                         *	I2C_TRANSFER_OPT_Type type that selected
                                                                         * for interrupt or polling mode.
                                                                         * @return 		SUCCESS or ERROR
                                                                         *
                                                                         * Note:
                                                                         ...
                                                                         * time out condition, during time out
                                                                         * condition, if there's no activity on I2C bus,
                                                                         * the slave will exit, otherwise (i.e. the
                                                                         * master send a SLA+R/W), the slave then switch
                                                                         * to relevant operation mode. The time out
                                                                         * should be used because the return status code
                                                                         * can not show difference from stop and repeat
                                                                         * start command in slave operation.
                                                                         * In case of the expected data length from
                                                                         * master is greater than data length that slave
                                                                         * can support:
...
/*********************************************************************/ /**
                                                                         * @brief		Set Own slave address in
                                                                         * I2C peripheral corresponding to parameter
...
/*********************************************************************/ /**
                                                                         * @brief		Configures functionality
                                                                         * in I2C monitor mode
                                                                         * @param[in]	I2Cx	I2C peripheral selected,
                                                                         * should be
                                                                         *   			- LPC_I2C0
                                                                         ...
                                                                         * 				-
                                                                         * I2C_MONITOR_CFG_SCL_OUTPUT: I2C module can
                                                                         * 'stretch' the clock line (hold it low) until
                                                                         * it has had time to respond to an I2C
                                                                         * interrupt.
                                                                         * 				-
                                                                         * I2C_MONITOR_CFG_MATCHALL: When this bit is
                                                                         * set to '1' and the I2C is in monitor mode, an
                                                                         * interrupt will be generated on ANY address
                                                                         * received.
...
/*********************************************************************/ /**
                                                                         * @brief		Get data from I2C data
                                                                         * buffer in monitor mode.
                                                                         * @param[in]	I2Cx	I2C peripheral selected,
                                                                         * should be
                                                                         *    			- LPC_I2C0
                                                                         * 				- LPC_I2C1
                                                                         * 				- LPC_I2C2
                                                                         * @return		None
                                                                         * Note:	In monitor mode, the I2C module
                                                                         * may lose the ability to stretch the clock
                                                                         * (stall the bus) if the ENA_SCL bit is not
                                                                         * set. This means that the processor will have
                                                                         * a limited amount of time to read the contents
                                                                         * of the data received on the bus. If the
                                                                         * processor reads the I2DAT shift register, as
                                                                         * it ordinarily would, it could have only one
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * 				- LPC_I2C1
                                                                         * 				- LPC_I2C2
                                                                         * @return 		Master transfer status,
                                                                         * could be:
                                                                         * 				- TRUE	master
                                                                         * transfer completed
                                                                         * 				- FALSE master
                                                                         * transfer have not completed yet
                                                                         **********************************************************************/
