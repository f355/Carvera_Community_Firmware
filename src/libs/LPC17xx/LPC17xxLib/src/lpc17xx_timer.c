...
/*********************************************************************/ /**
                                                                         * @brief 		Get peripheral clock of
                                                                         * each timer controller
                                                                         * @param[in]	timernum Timer number
                                                                         * @return 		Peripheral clock of
                                                                         * timer
                                                                         **********************************************************************/
static uint32_t getPClock(uint32_t timernum) {
...
/*********************************************************************/ /**
                                                                         * @brief 		Convert a time to a
                                                                         * timer count value
                                                                         * @param[in]	timernum Timer number
                                                                         * @param[in]	usec Time in microseconds
                                                                         * @return 		The number of required
                                                                         * clock ticks to give the time delay
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief 		Convert a timer register
                                                                         * pointer to a timer number
                                                                         ...
                                                                         * 				- LPC_TIM3:
                                                                         * TIMER3 peripheral
                                                                         * @return 		The timer number (0 to
                                                                         * 3) or -1 if register pointer is bad
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * device Set Clock frequency for Timer Set
...
void TIM_Init(LPC_TIM_TypeDef* TIMx, TIM_MODE_OPT TimerCounterMode, void* TIM_ConfigStruct) {
  ...
  if (TimerCounterMode == TIM_TIMER_MODE) {
    ...
    if (pCounterCfg->CountInputSelect == TIM_COUNTER_INCAP1) TIMx->CCR |= _BIT(2);
  }
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @param[in]	NewState
                                                                         * 				-	ENABLE
                                                                         * : set timer enable -	DISABLE : disable timer
                                                                         * @return 		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * device, Make TC and PC are synchronously
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * 					-
                                                                         * IntOnMatch	 : if SET, interrupt will be
                                                                         * generated when MRxx match the value in TC
                                                                         * 					-
                                                                         * StopOnMatch	 : if SET, TC and PC will be
                                                                         * stopped whenM Rxx match the value in TC
                                                                         * 					-
                                                                         * ResetOnMatch : if SET, Reset on MR0 when MRxx
                                                                         * match the value in TC -ExtMatchOutputType:
                                                                         * Select output for external match +	 0:
                                                                         *	Do nothing for external output pin if
                                                                         * match
                                                                         *						 +
                                                                         *   1:	Force external output pin to low if
                                                                         * match
                                                                         *						 +
                                                                         * 	 2: Force external output pin to high if
                                                                         * match
                                                                         *						 +
                                                                         * 	 3: Toggle external output pin if match
                                                                         *					MatchValue:
                                                                         * Set the value to be compared with TC value
                                                                         * @return 		None
                                                                         **********************************************************************/
void TIM_ConfigMatch(LPC_TIM_TypeDef* TIMx, TIM_MATCHCFG_Type* TIM_MatchConfigStruct) {
  ...
  if (TIM_MatchConfigStruct->IntOnMatch) TIMx->MCR |= TIM_INT_ON_MATCH(TIM_MatchConfigStruct->MatchChannel);

  // reset on MRn
  if (TIM_MatchConfigStruct->ResetOnMatch) TIMx->MCR |= TIM_RESET_ON_MATCH(TIM_MatchConfigStruct->MatchChannel);

  // stop on MRn
  if (TIM_MatchConfigStruct->StopOnMatch) TIMx->MCR |= TIM_STOP_ON_MATCH(TIM_MatchConfigStruct->MatchChannel);
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * TIMER3 peripheral
                                                                         * 					-
                                                                         * CaptureChannel: set the channel to capture
                                                                         * data
                                                                         * 					-
                                                                         * RisingEdge    : if SET, Capture at rising
                                                                         * edge
                                                                         * 					-
                                                                         * FallingEdge	: if SET, Capture at falling
                                                                         * edge
                                                                         * 					-
                                                                         * IntOnCaption  : if SET, Capture generate
                                                                         * interrupt
...
void TIM_ConfigCapture(LPC_TIM_TypeDef* TIMx, TIM_CAPTURECFG_Type* TIM_CaptureConfigStruct) {
  ...
  if (TIM_CaptureConfigStruct->RisingEdge) TIMx->CCR |= TIM_CAP_RISING(TIM_CaptureConfigStruct->CaptureChannel);

  if (TIM_CaptureConfigStruct->FallingEdge) TIMx->CCR |= TIM_CAP_FALLING(TIM_CaptureConfigStruct->CaptureChannel);

  if (TIM_CaptureConfigStruct->IntOnCaption) TIMx->CCR |= TIM_INT_ON_CAP(TIM_CaptureConfigStruct->CaptureChannel);
}

/*********************************************************************/ /**
                                                                         * @brief 		Read value of capture
                                                                         * register in timer/counter device
                                                                         ...
                                                                         * number, should be:
                                                                         * 				-
                                                                         * TIM_COUNTER_INCAP0: CAPn.0 input pin for
                                                                         * TIMERn
                                                                         * 				-
                                                                         * TIM_COUNTER_INCAP1: CAPn.1 input pin for
                                                                         * TIMERn
                                                                         * @return 		Value of capture
                                                                         * register
                                                                         **********************************************************************/
