...
/*********************************************************************/ /**
                                                                         * @brief 		Initial for Watchdog
                                                                         * function Clock source = RTC ,
                                                                         * @param[in]	ClkSrc  Select clock source,
                                                                         * should be:
                                                                         * 				-
                                                                         * WDT_CLKSRC_IRC: Clock source from Internal RC
                                                                         * oscillator
                                                                         * 				-
                                                                         * WDT_CLKSRC_PCLK: Selects the APB peripheral
                                                                         * clock (PCLK)
                                                                         * 				-
                                                                         * WDT_CLKSRC_RTC: Selects the RTC oscillator
                                                                         * @param[in]	WDTMode WDT mode, should be:
                                                                         * 				-
                                                                         * WDT_MODE_INT_ONLY: Use WDT to generate
                                                                         * interrupt only
                                                                         * 				-
                                                                         * WDT_MODE_RESET: Use WDT to generate interrupt
                                                                         * and reset MCU
                                                                         * @return 		None
                                                                         **********************************************************************/
...
/********************************************************************/ /**
                                                                        ...
                                                                        * @param[in]	None
                                                                        * @return		Time out flag status of
                                                                        * WDT
                                                                        *********************************************************************/
FlagStatus WDT_ReadTimeOutFlag(void) { return ((FlagStatus)((LPC_WDT->WDMOD & WDT_WDMOD_WDTOF) >> 2)); }
...
/********************************************************************/ /**
                                                                        * @brief 		Update WDT timeout value
                                                                        * and feed
...
/********************************************************************/ /**
                                                                        * @brief 		After set WDTEN, call
                                                                        * this function to start Watchdog or reload the
                                                                        * Watchdog timer
                                                                        * @param[in]	None
                                                                        *
                                                                        * @return		None
...
/********************************************************************/ /**
                                                                        * @brief 		Get the current value of
                                                                        * WDT
                                                                        * @param[in]	None
