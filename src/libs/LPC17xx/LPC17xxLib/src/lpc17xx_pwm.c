...
/*********************************************************************/ /**
                                                                         ...
                                                                         * should be:
                                                                         * 				-
                                                                         * PWM_INTSTAT_MR0: Interrupt flag for PWM match
                                                                         * channel 0
                                                                         * 				-
                                                                         * PWM_INTSTAT_MR1: Interrupt flag for PWM match
                                                                         * channel 1
                                                                         * 				-
                                                                         * PWM_INTSTAT_MR2: Interrupt flag for PWM match
                                                                         * channel 2
                                                                         * 				-
                                                                         * PWM_INTSTAT_MR3: Interrupt flag for PWM match
                                                                         * channel 3
                                                                         * 				-
                                                                         * PWM_INTSTAT_MR4: Interrupt flag for PWM match
                                                                         * channel 4
                                                                         * 				-
                                                                         * PWM_INTSTAT_MR5: Interrupt flag for PWM match
                                                                         * channel 5
                                                                         * 				-
                                                                         * PWM_INTSTAT_MR6: Interrupt flag for PWM match
                                                                         * channel 6
                                                                         * 				-
                                                                         * PWM_INTSTAT_CAP0: Interrupt flag for capture
                                                                         * input 0
                                                                         * 				-
                                                                         * PWM_INTSTAT_CAP1: Interrupt flag for capture
                                                                         * input 1
                                                                         * @return 		New State of PWM
...
/*****************************************************************************/ /**
                                                                                 * @brief		Fills each
                                                                                 * PWM_InitStruct member with its
                                                                                 * default value:
                                                                                 * 				- If
                                                                                 * PWMCounterMode = PWM_MODE_TIMER:
                                                                                 * 					+
                                                                                 * PrescaleOption =
                                                                                 ...
                                                                                 * PrescaleValue = 1
                                                                                 * 				- If
                                                                                 * PWMCounterMode = PWM_MODE_COUNTER:
                                                                                 * 					+
                                                                                 * CountInputSelect =
                                                                                 * PWM_COUNTER_PCAP1_0
                                                                                 * 					+
...
/*********************************************************************/ /**
                                                                         * @brief 		Initializes the PWMx
                                                                         * peripheral corresponding to the specified
                                                                         *               parameters in the
                                                                         * PWM_ConfigStruct.
                                                                         * @param[in]	PWMx PWM peripheral, should be
                                                                         * LPC_PWM1
                                                                         ...
                                                                         * 				-
                                                                         * PWM_MODE_TIMER: Counter of PWM peripheral is
                                                                         * in Timer mode
                                                                         * 				-
                                                                         * PWM_MODE_COUNTER: Counter of PWM peripheral
                                                                         * is in Counter mode
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * to a PWM_MATCHCFG_Type structure that
                                                                         * contains the configuration information for
                                                                         * the specified PWM match function.
                                                                         * @return 		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief 		Configures capture input
                                                                         * for PWM peripheral
                                                                         * @param[in]	PWMx	PWM peripheral selected,
                                                                         * should be LPC_PWM1
                                                                         ...
                                                                         * contains the configuration information for
                                                                         * the specified PWM capture input function.
                                                                         * @return 		None
                                                                         **********************************************************************/
...
/********************************************************************/ /**
                                                                        ...
                                                                        * PWM channel with update type option
                                                                        * @param[in]	PWMx	PWM peripheral selected,
                                                                        * should be LPC_PWM1
                                                                        ...
                                                                        * should be:
                                                                        * 				-
                                                                        * PWM_MATCH_UPDATE_NOW: The update value will be
                                                                        * updated for this channel immediately
                                                                        * 				-
                                                                        * PWM_MATCH_UPDATE_NEXT_RST: The update value
                                                                        * will be updated for this channel on next reset
                                                                        * by a PWM Match event.
                                                                        * @return		None
                                                                        *********************************************************************/
...
/********************************************************************/ /**
                                                                        * @brief 		Update value for multi
                                                                        * PWM channel with update type option at the
                                                                        * same time
                                                                        * @param[in]	PWMx	PWM peripheral selected,
                                                                        * should be LPC_PWM1
...
/********************************************************************/ /**
                                                                        ...
                                                                        * function, should be:
                                                                        * 				- ENABLE: Enable
                                                                        * this PWM channel output
                                                                        * 				- DISABLE:
                                                                        * Disable this PWM channel output
                                                                        * @return		None
                                                                        *********************************************************************/
