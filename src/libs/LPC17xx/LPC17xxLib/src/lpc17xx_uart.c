...
/*********************************************************************/ /**
                                                                         * @brief		Determines best dividers
                                                                         * to get a target clock rate
...
/*********************************************************************/ /**
                                                                         * @brief		Transmit a single data
                                                                         * through UART peripheral
                                                                         * @param[in]	UARTx	UART peripheral
                                                                         * selected, should be:
                                                                         *   			- LPC_UART0: UART0
                                                                         * peripheral
...
/*********************************************************************/ /**
                                                                         * @brief		Receive a single data
                                                                         * from UART peripheral
                                                                         * @param[in]	UARTx	UART peripheral
                                                                         * selected, should be:
                                                                         *  			- LPC_UART0: UART0
                                                                         * peripheral
...
/*********************************************************************/ /**
                                                                         * @brief		Send a block of data via
                                                                         * UART peripheral
...
/********************************************************************/ /**
                                                                        * @brief 		Get current value of
                                                                        * Line Status register in UART peripheral.
                                                                        * @param[in]	UARTx	UART peripheral
                                                                        * selected, should be:
                                                                        *  			- LPC_UART0: UART0
                                                                        * peripheral
                                                                        ...
                                                                        * Status register in UART peripheral. Note:
                                                                        *	The return value of this function must
                                                                        * be ANDed with each member in UART_LS_Type
                                                                        * enumeration to determine current flag status
                                                                        * 			corresponding to each
                                                                        * Line status type. Because some flags in Line
                                                                        * Status register will be cleared after reading,
                                                                        * the next reading Line Status register could
                                                                        * not be correct. So this function used to read
                                                                        * Line status register in one time only, then
                                                                        * the return value used to check all flags.
                                                                        *********************************************************************/
...
/********************************************************************/ /**
                                                                        ...
                                                                        * 				- LPC_UART3:
                                                                        * UART3 peripheral
                                                                        * @return		Current value of UART
                                                                        * UIIR register in UART peripheral.
                                                                        *********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Check whether if UART is
                                                                         * busy or not
                                                                         * @param[in]	UARTx	UART peripheral
                                                                         * selected, should be:
                                                                         *  			- LPC_UART0: UART0
                                                                         ...
                                                                         * 				- LPC_UART3:
                                                                         * UART3 peripheral
                                                                         * @return		RESET if UART is not
                                                                         * busy, otherwise return SET.
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Configure FIFO function
                                                                         * on selected UART peripheral
                                                                         * @param[in]	UARTx	UART peripheral
                                                                         * selected, should be:
                                                                         *  			- LPC_UART0: UART0
                                                                         * peripheral
                                                                         ...
                                                                         * specified information about FIFO
                                                                         * configuration
                                                                         * @return 		none
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * specified information about UART auto
                                                                         ...
                                                                         * this activity
                                                                         *				- DISABLE: Stop
                                                                         * this activity Note:		Auto-baudrate
                                                                         * mode enable bit will be cleared once this
                                                                         * mode completed.
                                                                         * @return 		none
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * 				- LPC_UART3:
                                                                         * UART3 peripheral
                                                                         * @param[in]	ABIntType	type of
                                                                         * auto-baud interrupt, should be:
                                                                         * 				-
                                                                         * UART_AUTOBAUD_INTSTAT_ABEO: End of Auto-baud
                                                                         * interrupt
                                                                         * 				-
                                                                         * UART_AUTOBAUD_INTSTAT_ABTO: Auto-baud time
                                                                         * out interrupt
                                                                         * @return 		none
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * inverting serial input function of IrDA on
                                                                         * UART peripheral.
...
/*********************************************************************/ /**
                                                                         * @brief		Enable or disable IrDA
                                                                         * function on UART peripheral.
                                                                         * @param[in]	UARTx UART peripheral selected,
                                                                         * should be LPC_UART3 (only)
...
/*********************************************************************/ /**
                                                                         * @brief		Get current status of
                                                                         * modem status register
                                                                         * @param[in]	UARTx	LPC_UART1 (only)
                                                                         * @return 		Current value of modem
                                                                         * status register Note:	The return value
                                                                         * of this function must be ANDed with each
                                                                         * member UART_MODEM_STAT_type enumeration to
                                                                         * determine current flag status corresponding
                                                                         * to each modem flag status. Because some flags
                                                                         * in modem status register will be cleared
                                                                         * after reading, the next reading modem
                                                                         * register could not be correct. So this
                                                                         * function used to read modem status register
                                                                         * in one time only, then the return value used
                                                                         * to check all flags.
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * peripheral in RS485 mode according to the
...
/*********************************************************************/ /**
                                                                         * @brief		Send data on RS485 bus
                                                                         * with specified parity stick value (9-bit
                                                                         * mode).
                                                                         * @param[in]	UARTx	LPC_UART1 (only)
                                                                         * @param[in]	pDatFrm 	Pointer to data
                                                                         * frame.
                                                                         * @param[in]	size		Size of data.
                                                                         * @param[in]	ParityStick	Parity Stick
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @return		None
                                                                         **********************************************************************/
void UART_RS485SendSlvAddr(LPC_UART1_TypeDef* UARTx, uint8_t SlvAddr) { UART_RS485Send(UARTx, &SlvAddr, 1, 1); }

/*********************************************************************/ /**
                                                                         * @brief		Send Data frames on
                                                                         * RS485 bus.
                                                                         * @param[in]	UARTx	LPC_UART1 (only)
