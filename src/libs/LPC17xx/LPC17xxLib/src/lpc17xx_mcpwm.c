...
/*********************************************************************/ /**
                                                                         * @brief		Configures each channel
                                                                         * in MCPWM peripheral according to the
                                                                         * 				specified
                                                                         * parameters in the MCPWM_CHANNEL_CFG_Type.
                                                                         * @param[in]	MCPWMx 			Motor
                                                                         * Control PWM peripheral selected should be:
                                                                         * LPC_MCPWM
                                                                         * @param[in]	channelNum		Channel
                                                                         * number, should be: 0..2.
                                                                         * @param[in]	channelSetup	Pointer to a
                                                                         * MCPWM_CHANNEL_CFG_Type structure that
                                                                         * contains the configuration information for
                                                                         * the specified MCPWM channel.
                                                                         * @return		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Write to MCPWM shadow
                                                                         * registers - Update the value for period and
                                                                         * pulse width in MCPWM peripheral.
                                                                         * @param[in]	MCPWMx 			Motor
                                                                         * Control PWM peripheral selected Should be:
                                                                         * LPC_MCPWM
                                                                         * @param[in]	channelNum		Channel
...
/*********************************************************************/ /**
                                                                         * @brief		Configures capture
                                                                         * function in MCPWM peripheral
                                                                         * @param[in]	MCPWMx 			Motor
                                                                         * Control PWM peripheral selected Should be:
                                                                         * LPC_MCPWM
                                                                         * @param[in]	channelNum		MCI
                                                                         * (Motor Control Input pin) number Should be:
                                                                         * 0..2
                                                                         * @param[in]	captureConfig	Pointer to a
                                                                         * MCPWM_CAPTURE_CFG_Type structure that
                                                                         * contains the configuration information for
                                                                         * the specified MCPWM capture.
                                                                         * @return
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Clears current captured
                                                                         * value in specified capture channel
                                                                         * @param[in]	MCPWMx 		Motor Control
                                                                         * PWM peripheral selected Should be: LPC_MCPWM
...
/*********************************************************************/ /**
                                                                         * @brief		Configures Count control
                                                                         * in MCPWM peripheral
                                                                         * @param[in]	MCPWMx 		Motor Control
                                                                         * PWM peripheral selected Should be: LPC_MCPWM
                                                                         ...
                                                                         * 							-
                                                                         * DISABLE: Disable count mode, the channel is
                                                                         * in timer mode.
...
/*********************************************************************/ /**
                                                                         * @brief		Start MCPWM activity for
                                                                         * each MCPWM channel
                                                                         * @param[in]	MCPWMx 		Motor Control
                                                                         * PWM peripheral selected Should be: LPC_MCPWM
                                                                         ...
                                                                         * 							-
                                                                         * ENABLE: 'Start' command will effect on
                                                                         * channel 0
                                                                         * 							-
                                                                         * DISABLE: 'Start' command will not effect on
                                                                         * channel 0
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * command on channel 0:
                                                                         * 							-
                                                                         * ENABLE: 'Stop' command will effect on channel
                                                                         * 0
                                                                         * 							-
                                                                         * DISABLE: 'Stop' command will not effect on
                                                                         * channel 0
                                                                         * @param[in]	channel1	State of this
                                                                         * command on channel 1:
                                                                         * 							-
...
/*********************************************************************/ /**
                                                                         * @brief		Enables/Disables 3-phase
                                                                         * AC motor mode on MCPWM peripheral
                                                                         * @param[in]	MCPWMx 		Motor Control
                                                                         * PWM peripheral selected Should be: LPC_MCPWM
...
/*********************************************************************/ /**
  ...
  * 								output pins route to the internal MCOA0 signal, should
  be:
...
/*********************************************************************/ /**
                                                                         * @brief		Sets/Forces the
                                                                         * specified interrupt for MCPWM peripheral
                                                                         * @param[in]	MCPWMx 		Motor Control
                                                                         * PWM peripheral selected Should be LPC_MCPWM
                                                                         * @param[in]	ulIntType	Interrupt type,
                                                                         * should be:
                                                                         ...
                                                                         * ORed together for using as input parameter.
                                                                         **********************************************************************/
void MCPWM_IntSet(LPC_MCPWM_TypeDef* MCPWMx, uint32_t ulIntType) { MCPWMx->MCINTFLAG_SET = ulIntType; }

/*********************************************************************/ /**
                                                                         * @brief		Clear the specified
                                                                         * interrupt pending for MCPWM peripheral
                                                                         * @param[in]	MCPWMx 		Motor Control
                                                                         * PWM peripheral selected, should be: LPC_MCPWM
                                                                         * @param[in]	ulIntType	Interrupt type,
                                                                         * should be:
                                                                         ...
                                                                         * ORed together for using as input parameter.
                                                                         **********************************************************************/
void MCPWM_IntClear(LPC_MCPWM_TypeDef* MCPWMx, uint32_t ulIntType) { MCPWMx->MCINTFLAG_CLR = ulIntType; }

/*********************************************************************/ /**
                                                                         * @brief		Check whether if the
                                                                         * specified interrupt in MCPWM is set or not
                                                                         * @param[in]	MCPWMx 		Motor Control
                                                                         * PWM peripheral selected, should be: LPC_MCPWM
                                                                         * @param[in]	ulIntType	Interrupt type,
                                                                         * should be:
