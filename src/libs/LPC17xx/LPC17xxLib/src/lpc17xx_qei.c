...
/*********************************************************************/ /**
                                                                         * @brief		Resets value for each
                                                                         * type of QEI value, such as velocity, counter,
                                                                         * position, etc..
                                                                         * @param[in]	QEIx			QEI
                                                                         * peripheral, should be LPC_QEI
                                                                         * @param[in]	ulResetType		QEI
                                                                         * Reset Type, should be one of the following:
                                                                         * 								-
...
/*********************************************************************/ /**
                                                                         * @brief		Initializes the QEI
                                                                         * peripheral according to the specified
                                                                         *               parameters in the
                                                                         * QEI_ConfigStruct.
                                                                         * @param[in]	QEIx
                                                                         *	QEI peripheral, should be LPC_QEI
                                                                         * @param[in]	QEI_ConfigStruct	Pointer
                                                                         * to a QEI_CFG_Type structure that contains the
...
/*****************************************************************************/ /**
                                                                                 * @brief		Fills each
                                                                                 * QIE_InitStruct member with its
                                                                                 * default value:
                                                                                 * 				-
                                                                                 ...
                                                                                 * to a QEI_CFG_Type structure which
                                                                                 * will be initialized.
                                                                                 * @return		None
                                                                                 *******************************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * specified flag status is set or not
                                                                         * @param[in]	QEIx		QEI peripheral,
                                                                         * should be LPC_QEI
                                                                         * @param[in]	ulFlagType	Status Flag
                                                                         * Type, should be one of the following:
                                                                         * 							-
                                                                         * QEI_STATUS_DIR: Direction Status
                                                                         * @return		New Status of this
                                                                         * status flag (SET or RESET)
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Set max position value
                                                                         * for QEI peripheral
                                                                         * @param[in]	QEIx		QEI peripheral,
                                                                         * should be LPC_QEI
                                                                         * @param[in]	ulMaxPos	Max position
                                                                         * value to set
                                                                         * @return		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Set position compare
                                                                         * value for QEI peripheral
                                                                         * @param[in]	QEIx		QEI peripheral,
                                                                         * should be LPC_QEI
                                                                         * @param[in]	bPosCompCh	Compare Position
                                                                         * channel, should be:
                                                                         * 							-
                                                                         * QEI_COMPPOS_CH_0: QEI compare position
                                                                         * channel 0
                                                                         * 							-
                                                                         * QEI_COMPPOS_CH_1: QEI compare position
                                                                         * channel 1
                                                                         * 							-
                                                                         * QEI_COMPPOS_CH_2: QEI compare position
                                                                         * channel 2
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * counter of QEI peripheral
                                                                         * @param[in]	QEIx		QEI peripheral,
                                                                         * should be LPC_QEI
                                                                         * @return		Current value of QEI
                                                                         * index counter
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Set value for index
                                                                         * compare in QEI peripheral
                                                                         * @param[in]	QEIx		QEI peripheral,
                                                                         * should be LPC_QEI
                                                                         * @param[in]	ulIndexComp		Compare
                                                                         * Index Value to set
                                                                         * @return		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * for QEI peripheral. When the velocity timer
                                                                         * is over-flow, the value that set for Timer
                                                                         * Reload register will be loaded into the
                                                                         * velocity timer for next period. The
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * counter in QEI peripheral
                                                                         * @param[in]	QEIx			QEI
                                                                         * peripheral, should be LPC_QEI
                                                                         * @return		Current timer counter in
                                                                         * QEI peripheral
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * pulse counter in current time period
                                                                         * @param[in]	QEIx			QEI
                                                                         * peripheral, should be LPC_QEI
                                                                         * @return		Current velocity pulse
                                                                         * counter value
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Get the most recently
                                                                         * measured velocity of the QEI. When the
                                                                         * Velocity timer in QEI is over-flow, the
                                                                         * current velocity value will be loaded into
...
/*********************************************************************/ /**
                                                                         * @brief		Set value of sampling
                                                                         * count for the digital filter in QEI
                                                                         * peripheral
                                                                         * @param[in]	QEIx			QEI
                                                                         * peripheral, should be LPC_QEI
...
/*********************************************************************/ /**
  ...
  * @param[in]	ulIntType		Interrupt Flag Status type, should be:
  ...
  interrupt
                                                                 - QEI_INTFLAG_VELC_Int: Capture velocity is less than
  compare interrupt
                                                                 - QEI_INTFLAG_DIR_Int: Change of direction interrupt
                                                                 - QEI_INTFLAG_ERR_Int: An encoder phase error interrupt
                                                                 - QEI_INTFLAG_ENCLK_Int: An encoder clock pulse was
  detected interrupt
                                                                 - QEI_INTFLAG_POS0_Int: position 0 compare value is
  equal to the current position interrupt
                                                                 - QEI_INTFLAG_POS1_Int: position 1 compare value is
  equal to the current position interrupt
                                                                 - QEI_INTFLAG_POS2_Int: position 2 compare value is
  equal to the current position interrupt
                                                                 - QEI_INTFLAG_REV_Int: Index compare value is equal to
  the current index count interrupt
                                                                 - QEI_INTFLAG_POS0REV_Int: Combined position 0 and
  revolution count interrupt
                                                                 - QEI_INTFLAG_POS1REV_Int: Combined position 1 and
  revolution count interrupt
                                                                 - QEI_INTFLAG_POS2REV_Int: Combined position 2 and
  revolution count interrupt
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * peripheral, should be LPC_QEI
                                                                         * @param[in]	ulIntType
                                                                         *	Interrupt Flag Status type, should be:
                                                                         * 								-
                                                                         * QEI_INTFLAG_INX_Int: index pulse was detected
                                                                         * interrupt
                                                                         *								-
...
/*********************************************************************/ /**
                                                                         * @brief		Calculates the actual
                                                                         * velocity in RPM passed via velocity capture
                                                                         * value and Pulse Per Round (of the encoder)
                                                                         ...
                                                                         * @param[in]	ulPPR			Pulse
                                                                         * per round of encoder
                                                                         * @return		The actual value of
                                                                         * velocity in RPM (Round per minute)
                                                                         **********************************************************************/
