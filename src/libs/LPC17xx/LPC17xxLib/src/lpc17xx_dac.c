...
/*********************************************************************/ /**
                                                                         * @brief 		To enable the DMA
                                                                         * operation and control DMA timer
                                                                         * @param[in]	DACx pointer to LPC_DAC_TypeDef,
                                                                         * should be: LPC_DAC
                                                                         * @param[in] 	DAC_ConverterConfigStruct
                                                                         * pointer to DAC_CONVERTER_CFG_Type
                                                                         * 					-
                                                                         * DBLBUF_ENA :  enable/disable DACR double
                                                                         * buffering feature
                                                                         * 					-
                                                                         * CNT_ENA    :  enable/disable timer out
                                                                         * counter
                                                                         * 					-
...
void DAC_ConfigDAConverterControl(LPC_DAC_TypeDef* DACx, DAC_CONVERTER_CFG_Type* DAC_ConverterConfigStruct) {
  ...
  if (DAC_ConverterConfigStruct->DBLBUF_ENA) DACx->DACCTRL |= DAC_DBLBUF_ENA;
  if (DAC_ConverterConfigStruct->CNT_ENA) DACx->DACCTRL |= DAC_CNT_ENA;
  if (DAC_ConverterConfigStruct->DMA_ENA) DACx->DACCTRL |= DAC_DMA_ENA;
}
