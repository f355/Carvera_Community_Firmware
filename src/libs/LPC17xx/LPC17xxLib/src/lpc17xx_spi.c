...
/*********************************************************************/ /**
                                                                         * @brief 		Setup clock rate for SPI
                                                                         * device
...
/*********************************************************************/ /**
                                                                         * @brief		Get data bit size per
                                                                         * transfer
                                                                         * @param[in]	SPIx	SPI peripheral selected,
                                                                         * should be LPC_SPI
                                                                         * @return 		number of bit per
                                                                         * transfer, could be 8-16
                                                                         **********************************************************************/
...
/*****************************************************************************/ /**
                                                                                 * @brief		Fills each
                                                                                 * SPI_InitStruct member with its
                                                                                 * default value:
                                                                                 * 				- CPHA =
                                                                                 * SPI_CPHA_FIRST
                                                                                 * 				- CPOL =
                                                                                 ...
                                                                                 * to a SPI_CFG_Type structure which
                                                                                 * will be initialized.
                                                                                 * @return		None
                                                                                 *******************************************************************************/
...
/********************************************************************/ /**
                                                                        * @brief 		Checks whether the SPI
                                                                        * interrupt flag is set or not.
                                                                        * @param[in]	SPIx	SPI peripheral selected,
                                                                        * should be LPC_SPI
                                                                        * @return 		The new state of SPI
...
/********************************************************************/ /**
                                                                        * @brief 		Get current value of SPI
                                                                        * Status register in SPIx peripheral.
                                                                        * @param[in]	SPIx	SPI peripheral selected,
                                                                        * should be LPC_SPI
                                                                        * @return		Current value of SPI
                                                                        * Status register in SPI peripheral. Note:
                                                                        *	The return value of this function must
                                                                        * be used with SPI_CheckStatus() to determine
