...
/********************************************************************/ /**
                                                                        ...
                                                                        * 				- I2S_RX_MODE =
                                                                        * 1: receive mode
                                                                        * @return 		The wordwidth value,
                                                                        * should be: 8,16 or 32
                                                                        *********************************************************************/
static uint8_t i2s_GetWordWidth(LPC_I2S_TypeDef* I2Sx, uint8_t TRMode) {
  uint8_t value;
...
/********************************************************************/ /**
                                                                        * @brief		I2S Start: clear all
                                                                        * STOP,RESET and MUTE bit, ready to operate
                                                                        * @param[in]	I2Sx I2S peripheral selected,
                                                                        * should be: LPC_I2S
                                                                        * @return 		none
                                                                        *********************************************************************/
...
/********************************************************************/ /**
                                                                        ...
                                                                        * 				- I2S_RX_MODE =
                                                                        * 1: receive mode
                                                                        * @return 		depth of FIFO level on
                                                                        * which to create an irq request
                                                                        *********************************************************************/
