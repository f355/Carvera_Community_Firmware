...
/*********************************************************************/ /**
                                                                         * @brief 		Setup clock rate for SSP
                                                                         * device
...
/*****************************************************************************/ /**
                                                                                 * @brief		Fills each
                                                                                 * SSP_InitStruct member with its
                                                                                 * default value:
                                                                                 * 				- CPHA =
                                                                                 * SSP_CPHA_FIRST
                                                                                 * 				- CPOL =
                                                                                 ...
                                                                                 * to a SSP_CFG_Type structure which
                                                                                 * will be initialized.
                                                                                 * @return		None
                                                                                 *******************************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * Back mode function in SSP peripheral
                                                                         * @param[in]	SSPx	SSP peripheral selected,
                                                                         * should be:
                                                                         *  					-
                                                                         * LPC_SSP0: SSP0 peripheral
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * Output function in SSP peripheral
                                                                         * @param[in]	SSPx	SSP peripheral selected,
                                                                         * should be:
                                                                         * 						-
                                                                         * LPC_SSP0: SSP0 peripheral
                                                                         ...
                                                                         * LPC_SSP1: SSP1 peripheral
                                                                         * @param[in]	NewState	New State of
                                                                         * Slave Output function, should be:
                                                                         * 							-
                                                                         * ENABLE: Slave Output in normal operation
                                                                         * 							-
                                                                         * DISABLE: Slave Output is disabled. This
                                                                         * blocks SSP controller from driving the
                                                                         * transmit data line (MISO) Note:
                                                                         *	This function is available when SSP
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @return 		Actual Data length has
                                                                         * been transferred in polling mode. In
                                                                         * interrupt mode, always return (0) Return (-1)
                                                                         * if error. Note: This function can be used in
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * specified SSP status flag is set or not
                                                                         * @param[in]	SSPx	SSP peripheral selected,
                                                                         * should be:
                                                                         * 		 				-
                                                                         * LPC_SSP0: SSP0 peripheral
                                                                         ...
                                                                         *							-
                                                                         * SSP_STAT_RXFIFO_NOTEMPTY: RX FIFO is not
                                                                         * empty
                                                                         *							-
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * specified interrupt type in SSP peripheral
                                                                         * @param[in]	SSPx	SSP peripheral selected,
                                                                         * should be:
                                                                         * 						-
                                                                         * LPC_SSP0: SSP0 peripheral
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * 						-
                                                                         * LPC_SSP1: SSP1 peripheral
                                                                         * @param[in]	RawIntType	Raw Interrupt
                                                                         * Type, should be:
                                                                         * 				-
                                                                         * SSP_INTSTAT_RAW_ROR: Receive Overrun
                                                                         * interrupt
                                                                         * 				-
                                                                         * SSP_INTSTAT_RAW_RT: Receive Time out
                                                                         * interrupt
                                                                         * 				-
                                                                         * SSP_INTSTAT_RAW_RX: RX FIFO is at least half
                                                                         * full interrupt
                                                                         * 				-
                                                                         * SSP_INTSTAT_RAW_TX: TX FIFO is at least half
                                                                         * empty interrupt
                                                                         * @return	New State of specified Raw
                                                                         * interrupt status flag in SSP peripheral Note:
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * 				-
                                                                         * SSP_INTSTAT_RX: RX FIFO is at least half full
                                                                         * interrupt
                                                                         * 				-
                                                                         * SSP_INTSTAT_TX: TX FIFO is at least half
                                                                         * empty interrupt
...
/*********************************************************************/ /**
                                                                         * @brief				Clear
                                                                         * specified interrupt pending in SSP peripheral
                                                                         * @param[in]	SSPx	SSP peripheral selected,
                                                                         * should be:
                                                                         *  					-
                                                                         * LPC_SSP0: SSP0 peripheral
                                                                         ...
                                                                         * received when RxFIFO was full" interrupt.
                                                                         * 						-
...
/*********************************************************************/ /**
                                                                         * @brief
                                                                         *	Enable/Disable DMA function for SSP
                                                                         * peripheral
                                                                         * @param[in]	SSPx	SSP peripheral selected,
                                                                         * should be:
                                                                         *  					-
