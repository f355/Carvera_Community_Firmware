...
#define QEI_IECLR_VELC_Int                                                                                            \
  ((uint32_t)(1 << 2)) /**< Clear Enabled Interrupt Bit Indicates that capture velocity is less than compare velocity \
                        */
...
#define QEI_IECLR_REV_Int                                                                                              \
  ((uint32_t)(1 << 9)) /**< Clear Enabled Interrupt Bit Indicates that the index compare value is equal to the current \
                                                               index count */
