...
#define PARAM_GPDMA_CONN(n)                                                                                            \
  ((n == GPDMA_CONN_SSP0_Tx) || (n == GPDMA_CONN_SSP0_Rx) || (n == GPDMA_CONN_SSP1_Tx) || (n == GPDMA_CONN_SSP1_Rx) || \
   (n == GPDMA_CONN_ADC) || (n == GPDMA_CONN_I2S_Channel_0) || (n == GPDMA_CONN_I2S_Channel_1) ||                      \
   (n == GPDMA_CONN_DAC) || (n == GPDMA_CONN_UART0_Tx) || (n == GPDMA_CONN_UART0_Rx) || (n == GPDMA_CONN_UART1_Tx) ||  \
   (n == GPDMA_CONN_UART1_Rx) || (n == GPDMA_CONN_UART2_Tx) || (n == GPDMA_CONN_UART2_Rx) ||                           \
   (n == GPDMA_CONN_UART3_Tx) || (n == GPDMA_CONN_UART3_Rx) || (n == GPDMA_CONN_MAT0_0) || (n == GPDMA_CONN_MAT0_1) || \
   (n == GPDMA_CONN_MAT1_0) || (n == GPDMA_CONN_MAT1_1) || (n == GPDMA_CONN_MAT2_0) || (n == GPDMA_CONN_MAT2_1) ||     \
...
typedef struct {
  ...
  uint32_t TransferType;  /**< Transfer Type, should be one of the following:
                                                  ...
                                                  - GPDMA_TRANSFERTYPE_P2P: Source peripheral to destination peripheral -
                             DMA control
                                                  */
