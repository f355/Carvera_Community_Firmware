...
static void configureUartForUseOfDebugger(UartParameters* pParameters) {
  ...
  static struct {
    uint32_t baudRate;
    uint32_t regValue;
  } const baudRateValues[] = {{1200, 0x0004F000},   {2400, 0x0009D000},   {4800, 0x0013B000},   {9600, 0x00275000},
                              {14400, 0x003B0000},  {19200, 0x004EA000},  {28800, 0x0075F000},  {38400, 0x009D5000},
                              {57600, 0x00EBF000},  {76800, 0x013A9000},  {115200, 0x01D7E000}, {230400, 0x03AFB000},
                              {250000, 0x04000000}, {460800, 0x075F7000}, {921600, 0x0EBED000}, {1000000, 0x10000000}};
...
int Platform_CommHasReceiveData(void) { return NRF_UART0->EVENTS_RXDRDY; }
...
static uint32_t hasTransmitCompleted(void) { return NRF_UART0->EVENTS_TXDRDY; }
