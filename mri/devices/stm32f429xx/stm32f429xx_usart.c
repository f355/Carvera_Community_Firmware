...
/* If the order of g_uartConfigurations changes,fix it!
    ...
    Return 2 for USART3
*/
static int commUartIndex(void) { return mriStm32f429xxState.pCurrentUart - g_uartConfigurations; }

int Platform_CommHasReceiveData(void) { return mriStm32f429xxState.pCurrentUart->pUartRegisters->SR & USART_SR_RXNE; }
