...
void platformMock_SetInitException(int exceptionToThrow) { g_initException = exceptionToThrow; }

int platformMock_GetInitCount() { return g_initCount; }

Token* platformMock_GetInitTokenCopy() { return &g_initTokenCopy; }
...
void Platform_Init(Token* pParameterTokens) {
  ...
  if (g_initException) __throw(g_initException);
}
...
int platformMock_CommGetHasTransmitCompletedCallCount(void) { return g_hasTransmitCompletedCount; }

// Platform_Comm* stubs called by MRI core.
int Platform_CommHasReceiveData(void) {
  if (isReceiveBufferEmpty()) {
    if (g_receiveIndex < ARRAY_SIZE(g_receiveBuffers)) g_receiveIndex++;
    return 0;
  }
...
static uint32_t isReceiveBufferEmpty() {
  if (g_receiveIndex >= ARRAY_SIZE(g_receiveBuffers)) return TRUE;
...
void Platform_CommSendChar(int character) {
  if (g_pTransmitDataBufferCurr < g_pTransmitDataBufferEnd) *g_pTransmitDataBufferCurr++ = (char)character;
}
...
int platformMock_GetEnteringDebuggerCalls(void) { return g_enteringDebuggerCount; }

int platformMock_GetLeavingDebuggerCalls(void) { return g_leavingDebuggerCount; }

// Stubs called by MRI core.
void Platform_EnteringDebugger(void) { g_enteringDebuggerCount++; }

void Platform_LeavingDebugger(void) { g_leavingDebuggerCount++; }
...
char* Platform_GetPacketBuffer(void) { return g_packetBuffer; }

size_t Platform_GetPacketBufferSize(void) { return g_packetBufferSize; }

// Semihost Instrumentation
static int g_isDebuggeeMakingSemihostCall;
static int g_getHandleSemihostRequestCount;

void platformMock_SetIsDebuggeeMakingSemihostCall(int setValue) { g_isDebuggeeMakingSemihostCall = setValue; }

int platformMock_GetHandleSemihostRequestCalls(void) { return g_getHandleSemihostRequestCount; }

// Semihost stubs called by MRI core.
int Semihost_IsDebuggeeMakingSemihostCall(void) { return g_isDebuggeeMakingSemihostCall; }
...
void platformMock_SetCauseOfException(uint8_t signal) { g_causeOfException = signal; }

int platformMock_DisplayFaultCauseToGdbConsoleCalls(void) { return g_displayFaultCauseToGdbConsoleCount; }

void platformMock_SetTrapReason(const PlatformTrapReason* pReason) { g_trapReason = *pReason; }

// Fault/Exception stubs called by MRI core.
uint8_t Platform_DetermineCauseOfException(void) { return g_causeOfException; }

PlatformTrapReason Platform_GetTrapReason(void) { return g_trapReason; }

void Platform_DisplayFaultCauseToGdbConsole(void) { g_displayFaultCauseToGdbConsoleCount++; }
...
void platformMock_SetTypeOfCurrentInstruction(PlatformInstructionType setValue) { g_instructionType = setValue; }

int platformMock_AdvanceProgramCounterToNextInstructionCalls(void) { return g_advanceProgramCounterToNextInstruction; }

int platformMock_SetProgramCounterCalls(void) { return g_setProgramCounterCalls; }

uint32_t platformMock_GetProgramCounterValue(void) { return g_programCounter; }

// Stubs called by MRI core.
PlatformInstructionType Platform_TypeOfCurrentInstruction(void) { return g_instructionType; }
...
int Platform_WasProgramCounterModifiedByUser(void) { return FALSE; }

uintmri_t Platform_GetProgramCounter(void) { return g_programCounter; }
...
void platformMock_SingleStepShouldAdvancePC(bool enable) { g_singleSteppingShouldAdvancePC = enable; }

void Platform_EnableSingleStep(void) {
  if (g_singleSteppingShouldAdvancePC) g_programCounter += 4;
  if (!g_singleSteppingForced) g_singleStepping = TRUE;
}

void Platform_DisableSingleStep(void) {
  if (!g_singleSteppingForced) g_singleStepping = FALSE;
}

int Platform_IsSingleStepping(void) { return g_singleStepping; }

// Memory Fault Test Instrumentation.
static int g_callToFail;

void platformMock_FaultOnSpecificMemoryCall(int callToFail) { g_callToFail = callToFail; }

// Stub called by MRI core.
int Platform_WasMemoryFaultEncountered(void) {
  if (g_callToFail == 0) return FALSE;
  g_callToFail--;
  if (g_callToFail == 0) return TRUE;
  return FALSE;
}
...
uintmri_t* platformMock_GetContextEntries(void) { return g_contextEntries; }

MriContext* platformMock_GetContext(void) { return &g_context; }

// Stubs called from MRI core.
void Platform_WriteTResponseRegistersToBuffer(Buffer* pBuffer) { Buffer_WriteString(pBuffer, "responseT"); }
...
int platformMock_SetHardwareBreakpointCalls(void) { return g_setHardwareBreakpointCalls; }

uint32_t platformMock_SetHardwareBreakpointAddressArg(void) { return g_setHardwareBreakpointAddressArg; }

uint32_t platformMock_SetHardwareBreakpointKindArg(void) { return g_setHardwareBreakpointKindArg; }
...
int platformMock_ClearHardwareBreakpointCalls(void) { return g_clearHardwareBreakpointCalls; }

uint32_t platformMock_ClearHardwareBreakpointAddressArg(void) { return g_clearHardwareBreakpointAddressArg; }

uint32_t platformMock_ClearHardwareBreakpointKindArg(void) { return g_clearHardwareBreakpointKindArg; }
...
int platformMock_SetHardwareWatchpointCalls(void) { return g_setHardwareWatchpointCalls; }

uint32_t platformMock_SetHardwareWatchpointAddressArg(void) { return g_setHardwareWatchpointAddressArg; }

uint32_t platformMock_SetHardwareWatchpointSizeArg(void) { return g_setHardwareWatchpointSizeArg; }

PlatformWatchpointType platformMock_SetHardwareWatchpointTypeArg(void) { return g_setHardwareWatchpointTypeArg; }
...
int platformMock_ClearHardwareWatchpointCalls(void) { return g_clearHardwareWatchpointCalls; }

uint32_t platformMock_ClearHardwareWatchpointAddressArg(void) { return g_clearHardwareWatchpointAddressArg; }

uint32_t platformMock_ClearHardwareWatchpointSizeArg(void) { return g_clearHardwareWatchpointSizeArg; }

PlatformWatchpointType platformMock_ClearHardwareWatchpointTypeArg(void) { return g_clearHardwareWatchpointTypeArg; }
...
__throws void Platform_SetHardwareBreakpointOfGdbKind(uintmri_t address, uintmri_t kind) {
  ...
  if (g_setHardwareBreakpointException) __throw(g_setHardwareBreakpointException);
}
...
__throws void Platform_ClearHardwareBreakpointOfGdbKind(uintmri_t address, uintmri_t kind) {
  ...
  if (g_clearHardwareBreakpointException) __throw(g_clearHardwareBreakpointException);
}
...
__throws void Platform_SetHardwareWatchpoint(uintmri_t address, uintmri_t size, PlatformWatchpointType type) {
  ...
  if (g_setHardwareWatchpointException) __throw(g_setHardwareWatchpointException);
}
...
__throws void Platform_ClearHardwareWatchpoint(uintmri_t address, uintmri_t size, PlatformWatchpointType type) {
  ...
  if (g_clearHardwareWatchpointException) __throw(g_clearHardwareWatchpointException);
}
...
// Stubs called by MRI core.
size_t Platform_GetDeviceMemoryMapXmlSize(void) { return sizeof(g_deviceMemoryMapXml) - 1; }

const char* Platform_GetDeviceMemoryMapXml(void) { return g_deviceMemoryMapXml; }

size_t Platform_GetTargetXmlSize(void) { return sizeof(g_targetXml) - 1; }
...
int platformMock_GetSemihostCallReturnValue(void) { return g_semihostCallReturnValue; }

int platformMock_GetSemihostCallErrno(void) { return g_semihostCallErrno; }
...
int platformMock_GetResetDeviceCalls(void) { return g_resetCount; }

// Stubs called by MRI core.
void Platform_ResetDevice(void) { g_resetCount++; }
...
void platformMock_RtosSetHaltedThreadId(uint32_t threadId) { g_rtosThreadId = threadId; }
...
void platformMock_RtosSetActiveThread(uint32_t threadId) { g_rtosActiveThread = threadId; }

void platformMock_RtosSetIsSetThreadStateSupported(int isSupported) { g_isRtosSetThreadStateSupported = isSupported; }
...
uint32_t platformMock_RtosGetThreadStateInvalidAttempts(void) { return g_rtosInvalidThreadAttempts; }

uint32_t platformMock_RtosGetRestorePrevThreadStateCallCount(void) { return g_rtosRestorePrevThreadStateCallCount; }

// Stubs called by MRI core.
uintmri_t Platform_RtosGetHaltedThreadId(void) { return g_rtosThreadId; }
...
uintmri_t Platform_RtosGetNextThreadId(void) {
  skipNullThreadIds();
  if (g_rtosThreadIndex >= g_rtosThreadCount) return 0;
  return g_pRtosThreads[g_rtosThreadIndex++];
}

static void skipNullThreadIds() {
  while (g_rtosThreadIndex < g_rtosThreadCount && g_pRtosThreads[g_rtosThreadIndex] == 0) g_rtosThreadIndex++;
}
...
MriContext* Platform_RtosGetThreadContext(uintmri_t threadId) {
  if (g_rtosContextThreadId == threadId) return g_pRtosContext;
  return NULL;
}

int Platform_RtosIsThreadActive(uintmri_t threadId) { return threadId == g_rtosActiveThread; }

int Platform_RtosIsSetThreadStateSupported(void) { return g_isRtosSetThreadStateSupported; }
...
void Platform_RtosSetThreadState(uintmri_t threadId, PlatformThreadState state) {
  ...
  for (size_t i = 0; i < g_rtosThreadStateCount; i++) {
    if (g_pRtosThreadStates[i].threadId == threadId || threadId == MRI_PLATFORM_ALL_THREADS ||
  ...
  if (!foundThread) g_rtosInvalidThreadAttempts++;
}

void Platform_RtosRestorePrevThreadState(void) { g_rtosRestorePrevThreadStateCallCount++; }

// Memory Cache instrumentation.
static int g_invalidateICacheCount;
int platformMock_GetSyncICacheToDCacheCalls(void) { return g_invalidateICacheCount; }

void Platform_SyncICacheToDCache(uintmri_t address, size_t size) { g_invalidateICacheCount++; }
...
extern "C" uint32_t Platform_HandleGDBCommand(Buffer* pBuffer) { return 0; }
