...
TEST(cmdRegisters, GetRegisters) {
  ...
  STRCMP_EQUAL(platformMock_CommChecksumData(
                   "$T05responseT#+$1111111111111111222222222222222233333333333333334444444444444444#+"),
               platformMock_CommGetTransmittedData());
}

TEST(cmdRegisters, SetRegisters) {
  platformMock_CommInitReceiveChecksummedData("+$G123456789abcdef0222222222222222233333333333333339abcdef012345678#",
                                              "+$c#");
  mriDebugException(platformMock_GetContext());
...
TEST(cmdRegisters, SetRegisters_BufferTooShort) {
  platformMock_CommInitReceiveChecksummedData("+$G123456789abcdef022222222222222223333333333333333fedcba987654321#",
                                              "+$c#");
  mriDebugException(platformMock_GetContext());
