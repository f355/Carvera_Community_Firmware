...
TEST(cmdThread, HCommand_UseValidContext_VerifyRegisterRead) {
  uintmri_t contextEntries[4] = {0x1111111111111111, 0x2222222222222222, 0x3333333333333333, 0x4444444444444444};
...
TEST(cmdThread, HCommand_UseValidContext_VerifyRegisterWrite) {
  ...
  platformMock_CommInitReceiveChecksummedData(
      "+$Hgbaadbeef#", "+$Gaaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbccccccccccccccccdddddddddddddddd#", "+$c#");
  mriDebugException(platformMock_GetContext());
  STRCMP_EQUAL(platformMock_CommChecksumData("$T05responseT#"
                                             "+$OK#"
                                             "+$OK#"
