...
TEST(cmdVCont, vContQst_VerifyOutput) {
  ...
  mriDebugException(platformMock_GetContext());
  STRCMP_EQUAL(platformMock_CommChecksumData("$T05responseT#+$vCont;c;C;s;S;r#+"),
...
TEST(cmdVCont,
     vCont_RangedSingleStep_StepOverOneOfTwoHardcodedBreakpointsInRange_NeedToContinueOverAnotherBreakpointToExit) {
  platformMock_SetTypeOfCurrentInstruction(MRI_PLATFORM_INSTRUCTION_HARDCODED_BREAKPOINT);
