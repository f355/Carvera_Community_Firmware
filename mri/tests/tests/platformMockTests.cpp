...
TEST(platformMock, CommChecksummedData_NoPacketJustNack) { STRCMP_EQUAL("-", platformMock_CommChecksumData("-")); }
...
TEST(platformMock, Platform_GetPacketBuffer_DefaultNoReturnNull) { CHECK_TRUE(Platform_GetPacketBuffer() != NULL); }
...
TEST(platformMock, Platform_GetDeviceMemoryMapXml) { CHECK_EQUAL(0, strcmp("TEST", Platform_GetDeviceMemoryMapXml())); }

TEST(platformMock, Platform_GetTargetXmlSize_Returns5) { CHECK_EQUAL(5, Platform_GetTargetXmlSize()); }

TEST(platformMock, Platform_GetTargetXml) { CHECK_EQUAL(0, strcmp("test!", Platform_GetTargetXml())); }
...
TEST(platformMock, Platform_RtosGetFirstThreadId_MockDefaultsToNull){CHECK_EQUAL(0, Platform_RtosGetFirstThreadId())}
