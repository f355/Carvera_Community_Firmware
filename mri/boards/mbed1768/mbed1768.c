...
static void fetchAndSaveMbedUid(void) { mriGetMbedUid(g_state.mbedUid); }

static void setMbedDetectedFlag(void) { g_state.flags |= FLAGS_MBED_DETECTED; }

const uint8_t* Platform_GetUid(void) { return g_state.mbedUid; }

size_t Platform_GetUidSize(void) { return sizeof(g_state.mbedUid); }

int mriMbed1768_IsMbedDevice(void) { return (int)(g_state.flags & FLAGS_MBED_DETECTED); }
